...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/06/11 13:24:47 by rhohls            #+#    #+#             */
/*   Updated: 2018/06/11 13:46:08 by rhohls           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				main(int argc, char** argv)
{
	...
	filename1 = "./mouli/gnl11_1.txt";
	filename2 = "./mouli/gnl11_2.txt";
...
//	fd2 = open(argv[2], O_RDONLY);
	...
	if (fd1 > 2 && fd2 > 2)
	{
		...
		if (ret1 != 1 || strcmp(line1, "The caller may provide a pointer to a malloced buffer for the line in") != 0)
		{
			...
			printf("Actual return was |%i| and |%s|\n", ret1, line1);
			errors++;
		}
